    ...
    def build(page: ft.Page, library, on_select_anime, on_open_settings):
        ...
        def render_grid(filter_text=""):
            ...
            for anime in all_animes:
                ...
                if only_favs[0]: continue # favoritos serão adicionados ao banco em uma próxima migração
